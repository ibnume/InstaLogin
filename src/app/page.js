...
export default function Home() {
  ...
  return (
    <Box className="w-screen flex items-center justify-center mt-10">
      <Box className="flex flex-row w-4/5 mt-[4rem] justify-center mb-[7rem]">
        <Box
          className="w-[380.3px] relative mt-8"
          sx={{
        ...
        <Box className="w-[350px]">
          ...
          >
            ...
            >
              ...
              >
                <input
                  className="bg-[#fafafa] w-[75%] text-[.7rem] pt-[9px] pb-[7px] pl-[8px] rounded-[2px] border-[1px] border-solid border-gray-300 mb-[0.45rem]"
                  type="email"
                  name="email"
                  id="email"
                ...
                />
                <input
                  className="bg-[#fafafa] w-[75%] text-[.7rem] pt-[9px] pb-[7px] pl-[8px] rounded-[2px] border-[1px] border-solid border-gray-300 mb-3"
                  type="password"
                  name="password"
                  id="password"
